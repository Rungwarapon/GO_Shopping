...
function Home() {
  ...
  const fetchData = () => {
    Axios.get("https://ec2-3-222-245-240.compute-1.amazonaws.com:3001/api/products", setload(true)).then(
      (res) => {
        SetProduct(res.data);
      }
    );
  ...
  const handleSubmit = (event) => {
    ...
    Axios.post("https://ec2-3-222-245-240.compute-1.amazonaws.com:3001/api/index/search", body).then(
      (response) => {
